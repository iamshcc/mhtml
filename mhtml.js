...
(async () => {
    ...
    const buildAssets = "./build/assets"; // Destination assets directory
    ...
    await copyDirectory(assetsDir, buildAssets);
    console.log(`Copied assets from ${assetsDir} to ${buildAssets}`);
})();
